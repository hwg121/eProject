...
import { Sprout, BookOpen, Wrench, Lightbulb, Play, Star, ArrowRight, Sparkles, Heart, Users, Award, Zap, Hammer, Leaf, Flower as FlowerPot, Palette, PlayCircle, Library } from 'lucide-react';
    ...
    <div className="space-y-20">
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          />
          <motion.div
            className="absolute -bottom-32 -right-32 w-80 h-80 bg-white/5 rounded-full blur-3xl"
            animate={{
              x: [0, -80, 0],
              y: [0, 60, 0],
              scale: [1, 0.8, 1],
          ...
          />
          <motion.div
            className="absolute top-1/2 left-1/2 w-96 h-96 bg-gradient-to-r from-white/5 to-emerald-300/10 rounded-full blur-3xl"
            animate={{
              rotate: [0, 360],
              scale: [1, 1.1, 1],
            }}
        ...
        <div className="relative z-10">
          ...
          >
            Welcome to{' '}
            <motion.span 
              className="bg-gradient-to-r from-emerald-200 via-green-200 via-teal-200 to-emerald-200 bg-clip-text text-transparent drop-shadow-2xl"
              animate={{
      ...
      >
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8">
          {stats.map((stat, index) => (
            ...
            >
              <motion.div 
                className={`text-4xl sm:text-6xl mb-4 p-4 sm:p-6 rounded-3xl bg-gradient-to-r ${stat.color} text-white shadow-2xl mx-auto w-fit`}
            ...
            >
              <Link to={feature.link} className="block h-full">
                <Card className="h-full group cursor-pointer" gradient={true} glow={true}>
                  <motion.div 
                    className={`text-white mb-8 p-6 bg-gradient-to-r ${feature.color} rounded-3xl w-fit shadow-2xl`}
