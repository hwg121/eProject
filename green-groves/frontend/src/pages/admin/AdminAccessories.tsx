  ...
  const [accessories, setAccessories] = useState<Accessory[]>([
    {
      ...
      size: '12 inches',
      color: 'Warm White',
      specifications: 'LED, Solar powered, 8-hour runtime',
    ...
    },
    {
      ...
      description: 'Whimsical garden gnomes to add character to your garden',
      category: 'Decorative',
      type: 'Ornament',
      material: 'Resin',
      size: '8 inches',
      color: 'Multicolor',
      specifications: 'Hand-painted, UV resistant, Set of 3',
